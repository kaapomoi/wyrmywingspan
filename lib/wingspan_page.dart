...
class _WingspanPageState extends State<WingspanPage> with AutomaticKeepAliveClientMixin<WingspanPage> {
  int sum = 0;
      ...
      Center(
        child: Column(
          ...
          children: [
            ...
            ScoreCounter(
                iconPath: "assets/wings/EndGameSlider_7_nectar.png", cb: addToSum),
            SizedBox(
              width: 320.0,
              height: 80.0,
