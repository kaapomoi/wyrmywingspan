...
class _WyrmspanPageState extends State<WyrmspanPage> with AutomaticKeepAliveClientMixin<WyrmspanPage> {
  int sum = 0;
      ...
      Center(
        child: Column(
          ...
          children: [
            ...
            ScoreCounter(
                iconPath: "assets/wyrms/guild.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wyrms/dragon.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wyrms/end_game_flag.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wyrms/egg.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wyrms/resource.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wings/EndGameSlider_6_tucked.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wings/EndGameSlider_3_goals.png", cb: addToSum),
            ScoreCounter(
                iconPath: "assets/wyrms/combo.png", cb: addToSum),
            SizedBox(
              width: 320.0,
              height: 80.0,
